...
/**
 * VIEW(view_stgg)表POJO类
 * QQ：464863696
 * @author hyberbin
 */
public class View_stgg {
/**  公告人  */
 ...
 * @param yhm 用户名
 */
public View_stgg(Integer ggr,Integer gglb,String lbmc,String ggnr,java.sql.Date ggsj,String ggbt,Integer ggid,String yhm) {
    this.ggr=ggr;
    this.gglb=gglb;
    this.lbmc=lbmc;
    this.ggnr=ggnr;
