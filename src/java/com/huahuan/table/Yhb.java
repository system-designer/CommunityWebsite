 ...
 * @param sinaid 新浪id
 */
public Yhb(Integer id,String yhm,String mm,String zsxm,String xb,java.sql.Date csrq,String yx,String yhtx,Boolean sfjh,java.sql.Timestamp zcsj,java.sql.Timestamp zhdlsj,Integer qx,Integer jf,String gxqm,Integer lsjf,Boolean sfzx,String qqid,String sinaid) {
    this.id=id;
    this.yhm=yhm;
    this.mm=mm;
    this.zsxm=zsxm;
